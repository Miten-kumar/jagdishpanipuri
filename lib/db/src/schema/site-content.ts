...
export const siteContentTable = pgTable("site_content", {
  ...
  heroSubtitle: text("hero_subtitle")
    .notNull()
    .default(
      "Fresh, bold flavors crafted with love — burgers, coffee, and everything in between.",
    ),
  ...
  aboutText: text("about_text")
    .notNull()
    .default(
      "Urban Bites was born from a passion for honest food and great coffee. We believe every bite should tell a story.",
    ),
  aboutImageUrl: text("about_image_url").notNull().default(""),
  restaurantName: text("restaurant_name").notNull().default("Urban Bites"),
  restaurantTagline: text("restaurant_tagline")
    .notNull()
    .default("Fresh. Bold. Delicious."),
  logoUrl: text("logo_url").notNull().default(""),
  address: text("address")
    .notNull()
    .default("123 Main Street, Downtown, NY 10001"),
  ...
  footerText: text("footer_text")
    .notNull()
    .default("2024 Urban Bites. All rights reserves."),
